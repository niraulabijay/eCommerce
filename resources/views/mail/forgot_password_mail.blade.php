                                ...
                                <td class="content-cell">
                                    ...
                                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <div>
                                                    <a href="{{ env('APP_URL') }}/reset/{{ $content['email'] }}/{{ $content['code'] }}" class="button button--blue"><span style="color:blue;">Reset Password</span></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="body-sub">
                                        <tr>
                                            <td>
                                                ...
                                                <p class="sub"><a href="{{ env('APP_URL') }}/reset/{{ $content['email'] }}/{{ $content['code'] }}">{{ env('APP_URL') }}/reset/{{ $content['email'] }}/{{ $content['code'] }}</a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
