    ...
    {{--//Special BY Category--}}
                ...
                <div class="card col-md-12 " style="margin-top: 40px;">
                    ...
                    <div class="card-header with-border">
                        <h3 class="card-title" style="font-weight: bold">Special By Categories
                            <a href="{{ route('add_special_category') }}" class="btn btn-sm btn-primary pull-right inline">Add</a>
                        </h3>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($special_categories as $special_category)
                                <tr>
                                    ...
                                    <td> {{  $special_category->category->title }} </td>
