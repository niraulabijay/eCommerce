...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b>Roozeko</b></span>
        </a>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <form action="/logout" method="post" id="logout">
                                        {{csrf_field()}}
                                        <a href="#" class="btn btn-default " onclick="document.getElementById('logout').submit()"><span class="glyphicon glyphicon-log-out"></span> Logout</a></a>
                                    </form>
                                </div>
                            </li>
                        </ul>
